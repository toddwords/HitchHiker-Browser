...
var currentPerformance = USER.currentPerformance;
...
function loadEventHandlers(){
	$('#newP').click(function(){
		...
		let perfName = (Object.keys(USER.performances).length+1).toString();
	...
	$('#addGuide').click(function(){
		...
		toServer("addGuide", {username:username})
	})
	$('#swapGuide').click(function(){
		var username = $('#audienceList').children(":selected").attr("id")
		toServer("swapGuide", {username:username})
	})
